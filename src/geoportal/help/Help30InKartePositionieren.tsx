            ...
            pretext={
              <>
                <p>
                  ...
                  Klicken und Ziehen, Scrollen) oder durch Touch-Gesten auf 
                  dem Bildschirm können Sie den Kartenausschnitt verschieben oder 
                ...
                <p>
                  Um gezielt nach einem Ort innerhalb des Stadtgebiets zu suchen, 
                  geben Sie dessen Namen in das Eingabefeld "Wohin?" unten links ein. 
                  Sobald Sie ein Zeichen eingegeben haben, erscheint eine Auswahlliste 
                  mit passenden Treffern. Die Trefferliste ändert sich und wird genauer, 
                  wenn Sie weitere Zeichen eingeben. Ein Symbol vor jedem Treffer zeigt an, 
                  um welche Art von Ort es sich handelt: einen <Icon name="circle" /> Stadtbezirk, 
                  ein{" "}<Icon name="pie-chart" /> Quartier, eine <Icon name="home" />{" "}
                  Adresse, eine <Icon name="road" /> Straße ohne Hausnummern, 
                  einen <Icon name="tag" /> Interessanten Ort ("Point of Interest", kurz POI), 
                  eine <Icon name="tags" />{" "} alternative POI-Bezeichnung, 
