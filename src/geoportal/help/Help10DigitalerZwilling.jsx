    ...
    <GenericModalMenuSection
      ...
      sectionContent=<GenericDigitalTwinReferenceTextComponent pretext={
        <>
          ...
          gehören auch die sogenannten <strong>Teilzwillinge</strong>. Das sind Anwendungen, die einen 
          ...
          verfügbaren Teilzwillingen gelangen Sie über den Dialog{" "} 
          <a 
              className="renderAsLink" 
              onClick={() => setAppMenuActiveMenuSection("karteninhalte")}>
                Karteninhalte hinzufügen
          </a>
          . In Vorbereitung befinden sich außerdem <strong>Fachzwillinge</strong>, die als 
          themenspezifische Konfigurationen des Geoportals realisiert werden, z. B. zur 
          zukunftsfähigen Mobilität, zu den Parks und Grünanlagen oder zum Klimawandel. Auch in 
          den Fachzwillingen werden Sie Visualisierungen und Funktionen finden, die wir im Geoportal 
          nicht oder zumindest nicht an prominenter Stelle anbieten können. 
        </>
        } 
      />
    />
