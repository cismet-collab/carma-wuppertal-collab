...
export const GazetteerText = () => {
  return (
    ...
    >
      <div>
        <b>2-stufiges Eingabeelement für Positionierung über Adresse oder andere Ortsbezeichnung 
        (2D und 3D)</b><br/> Text eingeben für unscharfe Suche im Verzeichnis der Ortsnamen | 
