    ...
    return (
      ...
      >
        <div>
          ...
          (<b>2D</b> und <b>3D</b>) | auf Benennungen klicken/tippen für Text- und Bildinformationen 
          zur Funktion und Bedienung ("Sekundärinformationen") | z. T. wechselseitige Verknüpfungen 
          zwischen den Sekundärinformationen sowie mit der Bedienungsanleitung im Anwendungsmenü
        </div>
      </ul>
    );
  };