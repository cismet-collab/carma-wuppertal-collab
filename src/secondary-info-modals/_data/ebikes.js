const data = {
  "Zweirad Otto": {
    ...
    "properties": {
      ...
      "info": {
        "header": "Verleihstation von E-Fahrrädern ",
        "title": "Zweirad Otto",
        "additionalInfo": "Erreichbar über die Nordbahntrasse.",
        "subtitle": "Bayreuther Straße 52"
      }
    }
  }
  ,
  "Bergische Museumsbahn": {
    ...
    "properties": {
      "id": "L_2",
      "typ": "Ladestation",
      "foto": "https://www.wuppertal.de/geoportal/emobil/raeder/fotos/akku_kohlfurther_bruecke.jpg",
      "pfand": [
        1,
        2
      ],
      ...
      "strasse": "Kohlfurther Brücke",
      "standort": "Bergische Museumsbahn",
      "bemerkung": "Ladestation mit Schließfächern, Radbügel vorhanden.",
      "betreiber": {
        "ort": "Wuppertal",
        "plz": "42281",
        "web": "https://www.wsw-online.de/wsw-energie-wasser/privatkunden/nachhaltigkeit/emobilitaet/",
      ...
      "zusatzinfo": "Die Ladeplätze befinden sich vor dem Haupteingang der Museumsbahn.",
      "zugangsarten": [
        "Freier Zugang."
      ],
      "gruener_strom": true,
      ...
      "info": {
        "header": "Ladestation für E-Fahrräder (online)",
        "title": "Bergische Museumsbahn",
        "additionalInfo": "Die Ladeplätze befinden sich vor dem Haupteingang der Museumsbahn.",
        "subtitle": "Kohlfurther Brücke 57"
      }
    }
  },
  "Skaterhalle Wicked Woods (VT)": {
    properties: {
      ...
      "foto": "https://www.wuppertal.de/geoportal/emobil/raeder/fotos/akku_wickedwoods.jpg",
      "bezirk": "Oberbarmen",
      "offen": "täglich 8.00 - 21.30 Uhr",
      "zusatzinfo": "Eingang zur Skaterhalle.",
      ...
      "signatur": "svg-signaturen/pikto_e-bike_gruen_freigestellt_2.svg",
      "signatur2": "svg-signaturen/pikto_e-bike_gruen_freigestellt_3.svg",
      "header": "Ladestationen für Elektro-Fahrräder",
      "header_color": "#24A234",
      "vectorId": 5
    }
  },
  "Fertighauswelt Wuppertal (VT)": {
    properties: {
      ...
      "status": true,
      "verfuegbar": "Es kann keine Aussage darüber getroffen werden, ob die Station momentan besetzt ist.",
      "foto": "https://www.wuppertal.de/geoportal/emobil/raeder/fotos/akku_fertighauswelt.jpg",
      "bezirk": "Oberbarmen",
      "offen": "https://www.wuppertal.de/geoportal/emobil/images-autos/pikto_24-7.png",
      "zusatzinfo": "Am Haupttor der Fertighauswelt Wuppertal.",
      "detailbeschreibung": "Erreichbar über die Nordbahntrasse.",
      "bemerkung": "Ladestation mit Schließfächern, Radbügel vorhanden.",
      "anzahl_plaetze": 7,
      "anzahl_ladepunkte": 6,
