...
const MeinStandortText = () => {
  return (
    <div>
      <p>
        Das Werkzeug &quot;Mein Standort&quot;{" "}
        <FontAwesomeIcon icon={faLocationArrow} /> wird nur
        auf mobilen Endgeräten wie Smartphones und
        Tablet-PC&#39;s angeboten, denn nur diese sind 
        ...
        Dieser Hinweis kann durch das Antippen einer beliebigen Stelle außerhalb
        seines Textfeldes geschlossen werden. Wenn Sie sich mit Ihrem Endgerät
...
export default MeinStandortText;
