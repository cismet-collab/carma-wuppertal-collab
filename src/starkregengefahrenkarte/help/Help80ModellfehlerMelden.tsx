...
interface Help80Props {
  defaultContextValues?: Partial<React.ContextType<typeof CustomizationContext>>;
  email?: string;
}

const Component = ({ defaultContextValues = {}, email }: Help80Props) => {
  const customizations =
    useContext<typeof CustomizationContext>(CustomizationContext) ||
