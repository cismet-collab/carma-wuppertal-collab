...
import GTMComponentDictionary from "./index";
...
export const AdditionalComponents: StoryObj<Args> = {
  args: {
    filter: "",
  },
  render: ({ filter }) => {
    ...
    const filteredEntries = Object.entries(GTMComponentDictionary).filter(
